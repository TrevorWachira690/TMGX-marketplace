...
export default function PostDetail() {
  ...
  async function handleCommentSubmit(event) {
    ...
    try {
      const newComment = await api.createComment(id, { content: commentText });
    ...
    <>
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
          <div className="mb-4">
            {hasImageGallery && allImages.length > 0 && (
              <div>
                <div className="relative w-full mb-3" ref={imageContainerRef}>
                  <img
                  ...
                  {allImages.length > 1 && currentImageIndex > 0 && (
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/60 hover:bg-black/80 text-white rounded-full flex items-center justify-center transition-colors duration-200"
                  ...
                  {allImages.length > 1 && currentImageIndex < allImages.length - 1 && (
                    <button
                      onClick={() => setCurrentImageIndex((prev) => prev + 1)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/60 hover:bg-black/80 text-white rounded-full flex items-center justify-center transition-colors duration-200"
